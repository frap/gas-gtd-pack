...
(defcustom pomodoro-break-start-sound "/Users/agasson/Music/sounds/tos-redalert.mp3"
  "Sound played when a break period starts"
  :group 'pomodoro
  :type 'string)

(defcustom pomodoro-sound-player "/opt/local/bin/sox"
...
(defcustom pomodoro-work-start-sound "/Users/agasson/Music/sounds/Gunshot"
...
(defface pomodoro-mode-line
  '((t (:foreground "tomato1")))
  "Pomodoro mode line color"
    :group 'faces)
...
(defun play-pomodoro-sound (sound)
  ...
  (start-process "pomodoro-sox" nil pomodoro-sound-player (expand-file-name sound) "-d"))
